  ...
  const dataProducts = (product, index) => {
    return (
      <tr key={index}>
          ...
          <img
            ...
            src={
              product.image.indexOf("http") === 0
                ? product.image
                : `http://localhost:4000/file/${product.image}`
            }
          />
        </td>
        ...
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{product.dateCreate}</Moment>
        </td>
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{product.dateUpdate}</Moment>
        </td>
        <td className="text-center">
          <button
            className="btn_3"
          ...
          <div className="cart_inner">
            <div className="table-responsive">
              <table className="table">
                ...
                <tbody>{currentData.map(dataProducts)}</tbody>
              </table>
              <Paginator
