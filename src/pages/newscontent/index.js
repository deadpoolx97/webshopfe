      ...
      <tr key={index}>
        ...
        <td className="text-center">
          <img
            ...
            src={
              news.image.indexOf("http") === 0
                ? news.image
                : `http://localhost:4000/file/${news.image}`
            }
          />
        </td>
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{news.dateCreate}</Moment>
        </td>
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{news.dateUpdate}</Moment>
        </td>
        <td>
          ...
          <div className="cart_inner">
            <div className="table-responsive">
              <table className="table">
                ...
                <tbody>{currentData.map(dataNews)}</tbody>
              </table>
              <Paginator
              ...
              <div className="checkout_btn_inner float-right">
                <button className="btn">
                  <a href="/add/news">Thêm bài viết</a>
                </button>
              </div>
            </div>
          </div>
