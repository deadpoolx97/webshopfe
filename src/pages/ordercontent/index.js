  ...
  const dataOrder = (order, index) => {
    return (
      <tr style={{ fontSize: "12px" }} key={index}>
        ...
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{order.dateCreate}</Moment>
        </td>
        <td className="text-center">
          <Moment format="YYYY/MM/DD">{order.dateUpdate}</Moment>
        </td>
        <td className="text-center">{order.note}</td>
        <td className="text-center">
          {<input type="checkbox" checked={order.status} />}
        </td>
        <td className="text-center">
          {order.carts.map((product, index) => {
            return (
          ...
          <div className="cart_inner">
            <div className="table-responsive">
              <table className="table">
                ...
                <tbody>{currentData.map(dataOrder)}</tbody>
              </table>
              <Paginator
